...
export default function RootLayout({
  ...
  const localBusinessSchema = {
    ...
    priceRange: "$79.990 - $149.990 CLP + IVA",
      ...
      itemListElement: [
        {
          "@type": "Offer",
          name: "Plan Básico",
          description: "Ideal para emprendedores que están comenzando su presencia online. Incluye diseño profesional, hasta 5 secciones, responsive, botón WhatsApp, formulario de contacto y SEO básico.",
          price: "79990",
          priceCurrency: "CLP",
        ...
        },
        {
          ...
          description: "La opción preferida por negocios que quieren una imagen más completa. Incluye todo lo del Plan Básico más correo corporativo, optimización adicional y soporte prioritario.",
          price: "119990",
          priceCurrency: "CLP",
          availability: "https://schema.org/InStock",
        },
        {
          "@type": "Offer",
          name: "Plan Pro",
          description: "Solución completa para empresas que buscan máximo rendimiento. Incluye dominio .cl, correo corporativo, SEO avanzado, Google Analytics, Google Search Console y soporte premium.",
          price: "149990",
          priceCurrency: "CLP",
          availability: "https://schema.org/InStock",
        },
