          ...
          {portfolioItems.map((project) => (
            <StaggerItem key={project.id}>
              <motion.div
                ...
                className="group overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm dark:border-white/10 dark:bg-neutral-900"
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image
                    src={project.image}
                    alt={`Página web para ${project.name}`}
                    fill
